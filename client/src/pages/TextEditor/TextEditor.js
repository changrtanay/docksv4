...
function SingleDoc() {
  ...
  const socket = useSocketConnection(process.env.REACT_APP_SERVER_URL);
  ...
  const handleDeleteDoc = () => {
    ...
    if (userInfo._id === doc.author)
      dispatch(deleteDocAction({ docId: documentId, cb }));
  };
    ...
    <main>
      <div className="doc-info">
        ...
        <div>
          ...
          >
            {doc?.isPublic ? <RiGitRepositoryPrivateFill /> : <MdPublic />}Set
            as {doc?.isPublic ? "Private" : "Public"}
          </button>
          <button
